const MOCKED_DATA = {
  ...
  optimizations: {
    ...
    azure_cold_tier_candidates: {
      count: 4,
      saving: 1124.8,
      options: { excluded_pools: {}, skip_cloud_accounts: [] },
      items: [
        {
          resource_id: "aa11bb22-cc33-4400-dd55-ee6677889900",
          resource_name: "nrlbackupstg01",
          cloud_resource_id: "/subscriptions/sub-001/resourceGroups/rg-backup/providers/Microsoft.Storage/storageAccounts/nrlbackupstg01",
          region: "Australia East",
          cloud_account_id: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
          cloud_type: "azure_cnr",
          owner: { id: "33e28316-f72f-4592-96c6-4766c963519b", name: "Lincoln Morton" },
          pool: { id: "6c936baf-5045-4326-9c8e-52337e56a19c", name: "Azure Prod", purpose: "budget" },
          is_excluded: false,
          current_tier: "Hot",
          target_tier: "Cool",
          gb: 2048,
          confidence: "high",
          signal_used: "last_access_time",
          saving: 312.4,
          detected_at: 1682054418,
          cloud_account_name: "Azure Prod",
        },
        {
          resource_id: "bb22cc33-dd44-5500-ee66-ff7788990011",
          resource_name: "archivlogs2023stg",
          cloud_resource_id: "/subscriptions/sub-001/resourceGroups/rg-archive/providers/Microsoft.Storage/storageAccounts/archivlogs2023stg",
          region: "Australia East",
          cloud_account_id: "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
          cloud_type: "azure_cnr",
          owner: { id: "33e28316-f72f-4592-96c6-4766c963519b", name: "Lincoln Morton" },
          ...
          gb: 5120,
          confidence: "medium",
          signal_used: "access_frequency",
          saving: 486.2,
          detected_at: 1682054418,
          cloud_account_name: "Azure Prod",
        },
        {
          resource_id: "cc33dd44-ee55-6600-ff77-001122334455",
          resource_name: "mlexperimentsblob",
          cloud_resource_id: "/subscriptions/sub-002/resourceGroups/rg-ml/providers/Microsoft.Storage/storageAccounts/mlexperimentsblob",
          region: "East US",
          cloud_account_id: "b2c3d4e5-f6a7-8901-bcde-f12345678901",
          cloud_type: "azure_cnr",
          owner: { id: "44f92317-g83g-5049-cge7-57877d74620c", name: "Rosa Hernandez" },
          pool: { id: "7d047cbg-6156-5d47-ad3c-6797bfd752b1", name: "Azure Dev", purpose: "budget" },
          is_excluded: false,
          current_tier: "Hot",
          target_tier: "Cool",
          gb: 890,
          ...
          saving: 215.7,
          detected_at: 1682054418,
          cloud_account_name: "Azure Dev",
        },
        {
          resource_id: "dd44ee55-ff66-7700-0011-223344556677",
          resource_name: "compliancereportsstg",
          cloud_resource_id: "/subscriptions/sub-001/resourceGroups/rg-compliance/providers/Microsoft.Storage/storageAccounts/compliancereportsstg",
