...
class TestCloudAccountApi(TestApiBase):
    ...
    def test_update_locked_by_user_organization_option(self):
        patch('rest_api.rest_api_server.controllers.base.BaseController.get_user_id',
              return_value=self._user_id).start()
        patch('rest_api.rest_api_server.handlers.v1.base.BaseAuthHandler.check_cluster_secret',
